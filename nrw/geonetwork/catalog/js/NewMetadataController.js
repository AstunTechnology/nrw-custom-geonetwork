      ...
      function (
          ...
          return gnMetadataManager
            ...
            .catch(function (response) {
              ...
              $rootScope.$broadcast("StatusUpdated", {
                ...
                error: data.description ? data.description : $translate.instant("createMetadataError-duplicateUUID"),
                timeout: 0,
                type: "danger"
              });
            });
        ...
        function loadMetadataIdentifierTemplates() {
          ...
          $http.get("../api/identifiers").then(function (response) {
            ...
            // skip IDs 0 and 1 for NRW - to not show Custom URN and Autogenerated URN options
            if ($scope.mdIdentifierTemplates.length > 2) {
              $scope.mdIdentifierTemplates = $scope.mdIdentifierTemplates.filter(item => item.id != 0 && item.id != 1);
            }
          });
        }
